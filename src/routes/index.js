...
const paymentOutRoutes = require("./paymentOutRoutes");
const purchaseReturnRoutes = require("./purchaseReturnRoutes");
const debitNoteRoutes = require("./debitNoteRoutes");
const salesReturnRoutes = require("./salesReturnRoutes");
const creditNoteRoutes = require("./creditNoteRoutes");
...
router.use("/payments-out", paymentOutRoutes);
